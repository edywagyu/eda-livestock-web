/* ============================================================
   ...
   挙動:
     ...
     - クリックで右からドロワーが開く (forest×gold プレミアムデザイン)
     - .primary-nav .nav-list の内容を自動コピー (Shop/定期便 は CTA と重複するため除外)
   2026-05-29: Tom 指示「シンプルで高級感 (forest×gold)」リデザイン
     - 絵文字を全廃 / 派手な緑 LINE ボタンを廃止しゴールド枠の上品な接点に
     - primary CTA = ゴールド塗り / 副 CTA = ゴールド枠ゴースト
   ============================================================ */
(function () {
  'use strict';
