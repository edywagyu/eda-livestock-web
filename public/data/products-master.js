...
(function(global) {
  ...
  const PRODUCTS_MASTER = [
    ...
    /* ===== 不揃い品セット（2026-09-03(木) 18:30 発売・会員限定ページの商品）=====
       和牛5種を各200g・計1kg。バラ焼肉／和牛ミンチ／ステーキ（赤身かミスジ）／霜降スライス／切り落とし。
       🔴 2026-09-20 ryotaro指示で中身を変更（赤身スライス→霜降スライス）。
       ⚠️ ステーキで利益率が大きく変わる。¥7,980(税抜¥7,389)に対し、
          赤身ステーキ(原価¥1,251)なら原価計¥4,605＝利益率37.7%、
          ミスジ(原価¥2,781・直近ロット)なら原価計¥6,135＝利益率17.0%。
          ミスジが続くと利益が飛ぶので、実際に何が入ったかはロット台帳で追うこと。
       listPrice は赤身ステーキ構成の単品合計¥11,950（ミスジ構成なら¥12,050）。低いほうを表示。
