...
(function(global) {
  ...
  const PRODUCTS_MASTER = [
          ...
          冷凍焼けの程度は【この商品詳細ページ】の2枚目で見せる（2026-09-02 ryotaro指示）。 */
    {
      ...
      description: '和牛5種を、各200g・計1kg。和牛ミンチ／ステーキ（ミスジか赤身がランダムで入ります）／赤身スライス（無くなり次第 霜降スライスとなります）／バラ焼肉／切り落とし。スライス・バラ焼肉・切り落としは冷凍焼けで、表面の色が黒っぽく変わっています。2枚目の写真が冷凍焼けの例です。ステーキは形が不揃いです。内容量も味も、通常の商品と同じです。見た目のぶんだけお安くしました。単品で買うと ¥10,850 → ¥7,980。',
      images: [
